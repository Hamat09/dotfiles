...
if [ "$CURRENT" = "0.900000" ]; then
  ...
  sed -i -e '37s/false/true/' -e '34s/20/3/' -e '35s/20/3/' -e '38s/{ 0, 0 }/{ 12, 12 }/' -e '10s/0/2/' -e 's/gaps_in = 10/gaps_in = 20/' -e 's/gaps_out = 20/gaps_out = 30/' -e '29s/active_opacity = 0.9/active_opacity = 1.0/' -e '30s/inactive_opacity = 0.7/inactive_opacity = 1.0/' -e 's/rounding = 5/rounding = 0/' -e 's/rounding_power = 10/rounding_power = 0/' -e '33s/false/true/' /home/hamato/.config/hypr/modules/decorations.lua

  sed -i -e 's/"margin-top": 10/"margin-top": 0/' -e 's/"margin-left": 10/"margin-left": 0/' -e 's/"margin-right": 10/"margin-right": 0/' /home/hamato/.config/waybar/config.jsonc
  ...
  sed -i -e 's/"margin-top": 10/"margin-top": 0/' -e 's/"margin-left": 10/"margin-left": 0/' -e 's/"margin-right": 10/"margin-right": 0/' /home/hamato/.config/wal/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 10/"margin-top": 0/' -e 's/"margin-left": 10/"margin-left": 0/' -e 's/"margin-right": 10/"margin-right": 0/' /home/hamato/.config/wallust/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 10/"margin-top": 0/' -e 's/"margin-left": 10/"margin-left": 0/' -e 's/"margin-right": 10/"margin-right": 0/' /home/hamato/.config/cwal/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 10/"margin-top": 0/' -e 's/"margin-left": 10/"margin-left": 0/' -e 's/"margin-right": 10/"margin-right": 0/' /home/hamato/.config/hellwal/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 10/"margin-top": 0/' -e 's/"margin-left": 10/"margin-left": 0/' -e 's/"margin-right": 10/"margin-right": 0/' /home/hamato/.config/aether/custom/waybar-config/config.jsonc
  ...
  sed -i -e 's/"margin-top": 10/"margin-top": 0/' -e 's/"margin-left": 10/"margin-left": 0/' -e 's/"margin-right": 10/"margin-right": 0/' /home/hamato/.config/matugen/style-base16/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 10/"margin-top": 0/' -e 's/"margin-left": 10/"margin-left": 0/' -e 's/"margin-right": 10/"margin-right": 0/' /home/hamato/.config/matugen/style-classic/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 10/"margin-top": 0/' -e 's/"margin-left": 10/"margin-left": 0/' -e 's/"margin-right": 10/"margin-right": 0/' /home/hamato/.config/iris/templates/config.jsonc
  ...
  sed -i -e '37s/true/false/' -e '34s/3/20/' -e '35s/3/20/' -e '38s/{ 12, 12 }/{ 0, 0 }/' -e '10s/2/0/' -e 's/gaps_in = 20/gaps_in = 10/' -e 's/gaps_out = 30/gaps_out = 20/' -e '29s/active_opacity = 1.0/active_opacity = 0.9/' -e '30s/inactive_opacity = 1.0/inactive_opacity = 0.7/' -e 's/rounding = 0/rounding = 5/' -e 's/rounding_power = 0/rounding_power = 10/' -e '33s/true/false/' /home/hamato/.config/hypr/modules/decorations.lua

  sed -i -e 's/"margin-top": 0/"margin-top": 10/' -e 's/"margin-left": 0/"margin-left": 10/' -e 's/"margin-right": 0/"margin-right": 10/' /home/hamato/.config/waybar/config.jsonc
  ...
  sed -i -e 's/"margin-top": 0/"margin-top": 10/' -e 's/"margin-left": 0/"margin-left": 10/' -e 's/"margin-right": 0/"margin-right": 10/' /home/hamato/.config/wal/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 0/"margin-top": 10/' -e 's/"margin-left": 0/"margin-left": 10/' -e 's/"margin-right": 0/"margin-right": 10/' /home/hamato/.config/wallust/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 0/"margin-top": 10/' -e 's/"margin-left": 0/"margin-left": 10/' -e 's/"margin-right": 0/"margin-right": 10/' /home/hamato/.config/cwal/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 0/"margin-top": 10/' -e 's/"margin-left": 0/"margin-left": 10/' -e 's/"margin-right": 0/"margin-right": 10/' /home/hamato/.config/hellwal/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 0/"margin-top": 10/' -e 's/"margin-left": 0/"margin-left": 10/' -e 's/"margin-right": 0/"margin-right": 10/' /home/hamato/.config/aether/custom/waybar-config/config.jsonc
  ...
  sed -i -e 's/"margin-top": 0/"margin-top": 10/' -e 's/"margin-left": 0/"margin-left": 10/' -e 's/"margin-right": 0/"margin-right": 10/' /home/hamato/.config/matugen/style-base16/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 0/"margin-top": 10/' -e 's/"margin-left": 0/"margin-left": 10/' -e 's/"margin-right": 0/"margin-right": 10/' /home/hamato/.config/matugen/style-classic/templates/config.jsonc
  ...
  sed -i -e 's/"margin-top": 0/"margin-top": 10/' -e 's/"margin-left": 0/"margin-left": 10/' -e 's/"margin-right": 0/"margin-right": 10/' /home/hamato/.config/iris/templates/config.jsonc
