...
if [ "$CURRENT" = "0.900000" ]; then
  ...
  sed -i -e 's/gaps_in = 10/gaps_in = 20/' -e 's/gaps_out = 20/gaps_out = 30/' -e '29s/active_opacity = 0.9/active_opacity = 1.0/' -e '30s/inactive_opacity = 0.7/inactive_opacity = 1.0/' -e '33s/enabled = false/enabled = true/' -e 's/rounding = 5/rounding = 0/' -e 's/rounding_power = 10/rounding_power = 0/' /home/hamato/.config/hypr/modules/decorations.lua
  ...
  sed -i -e 's/gaps_in = 20/gaps_in = 10/' -e 's/gaps_out = 30/gaps_out = 20/' -e '29s/active_opacity = 1.0/active_opacity = 0.9/' -e '30s/inactive_opacity = 1.0/inactive_opacity = 0.7/' -e '33s/enabled = true/enabled = false/' -e 's/rounding = 0/rounding = 5/' -e 's/rounding_power = 0/rounding_power = 10/' /home/hamato/.config/hypr/modules/decorations.lua
  ...
  sed -i -e 's/, 1.0)/, 0.7)/' -e 's/border: 0px/border: 2px/' -e 's/border-radius: 0px/border-radius: 5px/' -e '29s/10/7/' -e '30s/margin: 0px 0px 0px 0px/margin: 5px 0px 5px 5px/' /home/hamato/.config/wal/templates/style.css
  ...
  sed -i -e 's/, 1.0)/, 0.7)/' -e 's/border: 0px/border: 2px/' -e 's/border-radius: 0px/border-radius: 5px/' -e '29s/10/7/' -e '30s/margin: 0px 0px 0px 0px/margin: 5px 0px 5px 5px/' /home/hamato/.config/wallust/templates/style.css
  ...
  sed -i -e 's/, 1.0)/, 0.7)/' -e 's/border: 0px/border: 2px/' -e 's/border-radius: 0px/border-radius: 5px/' -e '29s/10/7/' -e '30s/margin: 0px 0px 0px 0px/margin: 5px 0px 5px 5px/' /home/hamato/.config/cwal/templates/style.css
  ...
  sed -i -e 's/, 1.0)/, 0.7)/' -e 's/border: 0px/border: 2px/' -e 's/border-radius: 0px/border-radius: 5px/' -e '29s/10/7/' -e '30s/margin: 0px 0px 0px 0px/margin: 5px 0px 5px 5px/' /home/hamato/.config/hellwal/templates/style.css
  ...
  sed -i -e 's/, 1.0)/, 0.7)/' -e 's/border: 0px/border: 2px/' -e 's/border-radius: 0px/border-radius: 5px/' -e '29s/10/7/' -e '30s/margin: 0px 0px 0px 0px/margin: 5px 0px 5px 5px/' /home/hamato/.config/aether/custom/waybar/style.css
  ...
  sed -i -e 's/, 1.0)/, 0.7)/' -e 's/border: 0px/border: 2px/' -e 's/border-radius: 0px/border-radius: 5px/' -e '29s/10/7/' -e '30s/margin: 0px 0px 0px 0px/margin: 5px 0px 5px 5px/' /home/hamato/.config/matugen/style-base16/templates/style.css
